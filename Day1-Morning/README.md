...
หากคุณติดตั้ง Miniconda คุณจะต้องติดตั้ง Jupyter Notebook เพิ่มเติม:

1. **ติดตั้งผ่าน conda** (สำหรับผู้ใช้ Miniconda):
...
หลังจากติดตั้ง Python และ Miniconda แล้ว ให้ติดตั้งไลบรารีต่อไปนี้:
...
การติดตั้งทั้งหมดในครั้งเดียวสามารถทำได้ด้วยคำสั่ง:
```
...
1. เปิด Anaconda Prompt (หากใช้ Miniconda) 
...
5. **Power BI Desktop** - เครื่องมือสำหรับสร้างวิชวลไลเซชันและแดชบอร์ด
